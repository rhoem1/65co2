...
20 S = RND(-PEEK(-12289)) : REM LOAD RNG
30 E$=CHR$(27)+"[":M$=CHR$(109)
31 W$=E$+"48;5;179"+M$+E$+"38;5;16"+M$
39 C$=E$+"0"+M$
103 H=25: V=25

110 H = INT((H-1)/3): V = INT((V-1)/2)
115 DIM W(H,V):DIM V(H,V)
120 PRINT
130 PRINT "Digging Maze";
140 PRINT
150 PRINT 
160 Q=0:Z=0:E=INT(RND(1)*H+1):X=E
170 T=H*V+1
...
810 IF C=T THEN 1010
815 Q=0:GOTO 260

820 W(R,S-1)=C 
830 C=C+1
840 V(R,S-1)=1:S=S-1:IF C=T THEN 1010
850 Q=0:GOTO 260
...
1010 FOR I=1 TO H
1012 IF I=E THEN 1014
1013 PRINT W$"+--";:GOTO 1015
1014 PRINT W$"+"C$"  ";
1015 NEXT I: PRINT W$"+"C$
1016 FOR J=1 TO V
1017 PRINT W$"|"C$;
1018 FOR I=1 TO H
1019 IF V(I,J)<2 THEN 1030
1020 PRINT C$"   "; : GOTO 1040
1030 PRINT "  "W$"|"C$;
1040 NEXT I
1041 PRINT C$
1043 FOR I=1 TO H
