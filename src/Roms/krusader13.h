#ifndef __krusader13_h__
#define __krusader13_h__

//#include "65o2.h"

#define KRUSADER 0xF000
#define KRUSADER_LENGTH 0xF00 

struct memoryInterceptKrusader : romIntercept {

	unsigned char assembler[KRUSADER_LENGTH] = {
	...
	virtual unsigned char read(unsigned short address) {
		return assembler[address - KRUSADER];
	};
};
