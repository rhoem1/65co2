...
ESC             equ     $9B            ;ESC key
PROMPT          equ     '\ | #$80           ;Prompt character
...
PRHEX           and     #%00001111    ;Mask LSD for hex print
                ora     #'0 | #$80           ;Add "0"
                cmp     (#'9 | #$80) + 1         ;Is it a decimal digit?
...
;-------------------------------------------------------------------------
                ...
                ORG $FFF8
                DC    #0,#0
NMI_VEC         DC    #00,#$0F          ;NMI vector
RESET_VEC       DC    <RESET,>RESET          ;RESET vector
IRQ_VEC         DC    #0,#0          ;IRQ vector
